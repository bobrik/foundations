use super::{info_metric, ExtraMetricsProducer, InfoMetric};
...
pub struct Registries {
    ...
    extra_producers: RwLock<Vec<Box<dyn ExtraMetricsProducer>>>,
}
...
impl Registries {
    ...
    pub fn add_extra_producer(&self, producer: Box<dyn ExtraMetricsProducer>) {
